...
class send_msgbox:
    def __init__(self, parentWidget):
        ...
        sizePolicy.setHeightForWidth(self.sendmsg_label.sizePolicy().hasHeightForWidth())
        self.sendmsg_label.setSizePolicy(sizePolicy)
        self.sendmsg_label.setMinimumSize(QtCore.QSize(0, 60))
        self.sendmsg_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
...
class recv_msgbox:
    def __init__(self, parentWidget):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.recvmsg_label.sizePolicy().hasHeightForWidth())
